...
function axes(palette:{text:string;grid:string},settings:ChartSettings,formatter:(value:number)=>string,percentageHasNegative=false){
  const category={stacked:settings.stacked,title:{display:Boolean(settings.xAxisTitle),text:settings.xAxisTitle,color:palette.text},grid:{display:false},ticks:{color:palette.text,minRotation:settings.xLabelRotation,maxRotation:settings.xLabelRotation}};
